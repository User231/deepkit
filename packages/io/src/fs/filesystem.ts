import { asyncOperation, Inject, isFunction, pathBasename, pathExtension, pathJoin, pathNormalize } from '@7b/runtime';
 ...
 * @example
 * ```typescript
 * import { provideNamedFilesystem, NamedFilesystem, FilesystemLocalAdapter } from '@7b/io/fs';
 ...
 * @example
 * ```typescript
 * import { provideFilesystem, Filesystem, FilesystemLocalAdapter } from '@7b/io/fs';
 * import { AppModule } from '@7b/core';
 *
 * new App({
