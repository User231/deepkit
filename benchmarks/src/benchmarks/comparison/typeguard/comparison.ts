...
// Typia requires AOT compilation - not included in comparison
// To add typia: create typia-src/validators.ts with typia.createIs<Model>() etc.
// Then run: npx typia generate --input typia-src --output typia-generated
...
try {
    ...
    typeboxCompiler = await import('@sinclair/typebox/compiler');
} catch {}
